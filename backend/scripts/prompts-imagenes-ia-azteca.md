...
#### Náhual (`nahual.jpg`)
```
Semi-realistic fantasy digital painting, full body dynamic action portrait, dramatic low-angle chiaroscuro lighting, a powerful Aztec sorcerer captured mid-transformation into a jaguar, back arched in a violent twisting pose, spine visibly shifting beneath stretching skin, dark fur erupting in patches across muscular arms and shoulders, one hand already a clawed jaguar paw while the other remains human and clenched, jaw mid-elongation with sharp fangs breaking through, glowing turquoise magical energy and swirling mist erupting from the transformation point, intricate ornate Aztec jewelry and torn ceremonial garments, ancient moonlit jungle ruins with carved stone jaguar heads in the background, atmospheric haze, dynamic diagonal composition, highly detailed digital art, painterly rendering with visible expressive brushwork, trending on artstation, cinematic dramatic lighting, jaguar-spot black and electric turquoise and moonlit silver color palette, raw visceral energy, sense of immense physical power being unleashed
```

#### Coyotlináhual (`coyotlinahual.jpg`)
```
Semi-realistic fantasy digital painting, full body portrait, vertical portrait orientation (taller than wide, aspect ratio approximately 2:3), dramatic chiaroscuro lighting, coyote-featured artisan sorcerer with a lean craftsman build, intricate feathered garments he is crafting, feather-work workshop in the misty background, atmospheric haze, centered symmetrical composition, highly detailed digital art, painterly rendering, trending on artstation, cinematic lighting, warm amber gold and feather-iridescent teal and earthy brown color palette, coyote-like facial features, hands delicately arranging quetzal feathers into an elaborate garment, workshop filled with colorful feathers
```
...
```
Semi-realistic fantasy digital painting, full body portrait, vertical portrait orientation (taller than wide, aspect ratio approximately 2:3), dramatic chiaroscuro lighting, body type and physique matching the character's own nature and role rather than a uniform idealized build, intricate ornate Aztec jewelry and elegant Toltec royal garment details, torch-lit ceremonial hall in the misty background, atmospheric haze, centered symmetrical composition, highly detailed digital art, painterly rendering, trending on artstation, cinematic lighting, warm torchlight gold and deep violet and pulque amber color palette, elegant young noblewoman with a graceful poised build, holding an ornate ceremonial cup mid-toast, composed expression with a flicker of unease behind her eyes, firelight catching her jewelry
```

#### La princesa desollada de Culhuacán (`princesa-de-culhuacan.jpg`)
```
Semi-realistic fantasy digital painting, full body portrait, vertical portrait orientation (taller than wide, aspect ratio approximately 2:3), dramatic chiaroscuro lighting, body type and physique matching the character's own nature and role rather than a uniform idealized build, intricate ornate Aztec royal jewelry and feathered garment details, torch-lit temple interior in the misty background, atmospheric haze, centered symmetrical composition, highly detailed digital art, painterly rendering, trending on artstation, cinematic lighting, deep red and gold and shadow black color palette, radiant young princess with a graceful noble build, being adorned with elaborate jade jewelry and a feathered headdress by attendants for what she believes is a wedding ceremony, serene confident expression, unaware, dramatic shadows looming at the edges of the firelit hall
```
