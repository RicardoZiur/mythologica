...
### Ixchel
```
Semi-realistic fantasy digital painting, full body portrait, dramatic chiaroscuro lighting, a graceful mature build, an elaborate huipil woven with moon and rainbow motifs, jade and shell jewelry, a rabbit faintly visible curled at her feet, a crescent moon glowing softly behind her head, a distant island temple over calm turquoise sea in the misty background, atmospheric haze, centered symmetrical composition, highly detailed digital art, painterly rendering, trending on artstation, cinematic lighting, silver moonlight and turquoise and warm coral color palette, a serene lunar goddess of medicine and weaving, a small loom visible at her side, calm and nurturing
```
